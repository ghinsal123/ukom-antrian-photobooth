            ...
            <form action="{{ route('customer.antrian.update', $antrian->id) }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full p-2.5 border rounded-lg bg-gray-50 text-sm" 
                            value="{{ $antrian->pengguna->nama_pengguna }}" disabled>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="no_telp" value="{{ $antrian->pengguna->no_telp }}" 
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal" value="{{ $antrian->tanggal }}" 
                                class="w-full p-2.5 border rounded-lg bg-gray-100 text-sm cursor-not-allowed" readonly>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="border rounded-lg p-3 bg-gray-50">
                            ...
                            <img id="previewPaket" src="{{ asset('storage/' . $antrian->paket->gambar) }}" 
                        ...
                        <div class="border rounded-lg p-3 bg-gray-50">
                            ...
                            <img id="previewBooth" src="{{ asset('storage/' . $antrian->booth->gambar) }}" 
                                class="w-full h-32 object-cover rounded-lg mb-2">
                    ...
                    <!-- tombol simpan -->
                    <div class="pt-2">
                        <button type="submit" class="w-full bg-pink-400 text-white py-2.5 rounded-lg font-semibold hover:bg-pink-500 transition text-sm">
                            Simpan Perubahan
                        </button>
                    </div>
