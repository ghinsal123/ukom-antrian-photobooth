...
<body class="bg-pink-50 flex items-center justify-center min-h-screen p-6">
    ...
    <div class="bg-white shadow-lg rounded-3xl p-10 w-full max-w-md text-center">
        ...
        <p class="text-gray-600 mb-8">
            Kamu akan keluar dari akun operator dan kembali ke halaman login.
        </p>
        ...
        <div class="space-y-3">
            ...
            <form action="{{ route('operator.logout') }}" method="POST">
                ...
                <button type="submit"
                    class="w-full bg-pink-400 hover:bg-pink-500 text-white py-3 rounded-xl font-semibold transition">
                    Logout Sekarang
                </button>
            </form>
