...
<body class="bg-pink-50">
    ...
    <div class="max-w-6xl mx-auto px-4 py-8 space-y-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
            <h3 class="text-lg sm:text-xl font-semibold text-gray-800">Halo, <?php echo e($pengguna->nama_pengguna); ?></h3>
                ...
                <?php else: ?>
                    <div class="space-y-3 flex-1">
                       ...
                       <!-- Tombol Batal dengan Modal -->
                                        <button type="button" onclick="openCancelModal(<?php echo e($item->id); ?>)"
                                                class="px-3 py-1 text-xs rounded-md bg-red-100 text-red-700">
                                            Batal
                                        </button>

                                        <div id="cancelModal-<?php echo e($item->id); ?>" class="hidden fixed inset-0 bg-black/40 z-50 flex items-center justify-center">
                                            <div class="bg-white p-6 rounded-xl w-[350px]">
                                                <h3 class="font-semibold text-gray-800 mb-3">Batalkan Antrian #<?php echo e($item->nomor_antrian); ?></h3>
